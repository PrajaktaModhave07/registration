...
if (isset($_POST['submit'])) {
	...
	if ($password == $cpassword) {
		...
		if (!$result->num_rows > 0) {
			...
			if ($result) {
				echo "<script>alert('Wow! you have successfully Registered.')</script>";
				$username = "";
				$dob= "";
				$gender = "";
				$_POST['password'] = "";
...
<head>
	...
	<title>Register Form - Olacademy </title>
</head>
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
			...
			<div class="input-group">
				<input type="text" placeholder="gender(F/M/O)" name="gender" value="<?php echo $gender; ?>" required>
			</div>
			<div class="input-group">
